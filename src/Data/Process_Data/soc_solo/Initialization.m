...
if i == 1
    ...
    Estim_Results.SOC_LUT_T(1,:) = SOC_LUT;
    Estim_Results.Em_LUT_T(1,:) = Em_LUT;
    Estim_Results.R0_LUT_T(1,:) = R0_LUT;
    Estim_Results.C1_LUT_T(1,:) = C1_LUT;
    Estim_Results.C2_LUT_T(1,:) = C2_LUT;
    Estim_Results.R1_LUT_T(1,:) = R1_LUT;
    Estim_Results.R2_LUT_T(1,:) = R2_LUT;
    Estim_Results.QParam(1,1) = Q5;
    Estim_Results.TParam(1,1) = T_init;
...
elseif i==2
    ...
    % Guardar valores de los parámetros en un lugar común para todas las Temperaturas
    Estim_Results.SOC_LUT_T(2,:) = SOC_LUT;
    Estim_Results.Em_LUT_T(2,:) = Em_LUT;
    Estim_Results.R0_LUT_T(2,:) = R0_LUT;
    Estim_Results.C1_LUT_T(2,:) = C1_LUT;
    Estim_Results.C2_LUT_T(2,:) = C2_LUT;
    Estim_Results.R1_LUT_T(2,:) = R1_LUT;
    Estim_Results.R2_LUT_T(2,:) = R2_LUT;
    Estim_Results.QParam(2,1) = Q25;
    Estim_Results.TParam(2,1) = T_init;
    ...
    % Guardar valores de los parámetros en un lugar común para todas las Temperaturas
    Estim_Results.SOC_LUT_T(3,:) = SOC_LUT;
    Estim_Results.Em_LUT_T(3,:) = Em_LUT;
    Estim_Results.R0_LUT_T(3,:) = R0_LUT;
    Estim_Results.C1_LUT_T(3,:) = C1_LUT;
    Estim_Results.C2_LUT_T(3,:) = C2_LUT;
    Estim_Results.R1_LUT_T(3,:) = R1_LUT;
    Estim_Results.R2_LUT_T(3,:) = R2_LUT;
    Estim_Results.QParam(3,1) = Q45;
    Estim_Results.TParam(3,1) = T_init;
end

save('Estim_Results.mat','Estim_Results')